    ...
    <div className="w-full bg-background">
      ...
      >
        ...
        <div className="relative z-10">
          <div
            className="sticky top-0 flex flex-col items-center justify-center min-h-screen pt-20 pb-16"
            style={{
              position: mediaFullyExpanded ? 'relative' : 'sticky',
            }}
          >
                ...
                {mediaType === 'video' ? (
                  mediaSrc.includes('youtube.com') ? (
                    <div className="relative w-full h-full">
                      <iframe
                        src={`${mediaSrc}?autoplay=1&mute=1&loop=1&controls=0&showinfo=0&rel=0&modestbranding=1`}
